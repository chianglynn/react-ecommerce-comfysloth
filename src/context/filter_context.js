...
import {
  ...
  UPDATE_SORT, SORT_PRODUCTS, UPDATE_FILTERS, FILTER_PRODUCTS, CLEAR_FILTERS
} from '../actions';
...
export const FilterProvider = ({ children }) => {
  ...
  const updateFilters = (e) => {
    ...
    // filter value = search, company, price || category || color
    let value = e.target.value || e.target.textContent || e.target.dataset.color;

    if (name === 'text' && !value) value = '';
